The Smart Clinic Queue Management System is a web-based application developed using Python and Flask. It is designed to help manage patient flow in a clinic by organizing patients in a First-In, First-Out (FIFO) queue system.
